...
extension ViewController {
    ...
    func setupNavigationBar() {
        ...
        mergeScanButton = UIBarButtonItem(
            title: "Merge Scans…",
            style: .plain,
            target: self,
            action: #selector(addScanButtonTapped(_:))
        )
//        let startOverButton = UIBarButtonItem(
//            title: "Restart",
//            style: .plain,
//            target: self,
...
//        navigationItem.setRightBarButtonItems([navigationItem], animated: true)
        navigationItem.leftBarButtonItems = [backButton]
//        navigationItem.rightBarButtonItems = [startOverButton]
...
//            let navItem = navBar.items?.first
//        else { return }
//        if show {
